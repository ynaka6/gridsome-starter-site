      ...
      <div class="w-full max-w-screen-xl relative mx-auto px-6">
        <div class="flex items-center justify-between flex-wrap">
          <div class="flex items-center flex-no-shrink text-blue mr-6">
            <g-image src="~/favicon.png" width="30" class="mr-2" />
            <h1 class="text-lg">
          ...
          <div class="w-full hidden lg:block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-sm lg:flex-grow">
              <g-link class="mr-3" to="/">Home</g-link>
              <g-link class="mr-3" to="/about">About</g-link>
              <g-link class="mr-3" to="/term">Term</g-link>
            </div>
          </div>
